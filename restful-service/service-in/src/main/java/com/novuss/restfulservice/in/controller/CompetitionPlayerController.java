...
import com.novuss.restfulservice.in.converter.competitionPlayer.CompetitionPlayerDomainToResponseConverter;
import com.novuss.restfulservice.in.converter.competitionPlayer.CreateCompetitionPlayerInRequestToDomainConverter;
import com.novuss.restfulservice.in.converter.competitionPlayer.UpdateCompetitionPlayerInRequestToDomainConverter;
...
public class CompetitionPlayerController {
    ...
    public ResponseEntity<List<CompetitionPlayerResponse>> getAll(@RequestHeader("Authorization") String authorizationHeader,
                                                                  @PathVariable("competitionId") String competitionId) {
        log.info("Received get all competition players request");
